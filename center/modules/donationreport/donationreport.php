    ...
    if($_REQUEST["action"]=="")
    {
     ...
     <section class="box ">
      ...
      <div class="content-body">
        ...
        echo "select * from ".TABLE_PREFIX."donation_master where payment_is_delete=0 and payment_status=1 and date ='".date('Y-m-d')."' and center_id='".$_SESSION[SESSION_PREFIX.'login-center-id']."' ";
