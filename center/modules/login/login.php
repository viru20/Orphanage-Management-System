...
function validation()
{
    ...
    <!-- BEGIN BODY -->
    <body class="login_page" style="background-image: url('back2.jpg') !important; background-repeat: no-repeat;background-size: cover;">


        <div class="login-wrapper">
            <div id="login" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8" style="background: rgb(25 34 42 / 85%);">
             <div align="center" style="margin-top: 10px;"> 
            <img src="logo.png" class="logo_hi_wi" >
               </div>
                ...
                ?>
                    <p>
                        <label for="user_login">Email<br />
                            <input type="email"  name="adminusername" id="adminusername" class="input" size="20" /></label>
                    </p>
                    <p>
