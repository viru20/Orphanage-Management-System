            ...
            <form method="post" action="">
              <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
               ...
               <tbody>
                ...
                <a href="<?php echo ADOPTREPORT;?>process.php?action=download&from=<?php echo $_REQUEST['from'];?>&to=<?php echo $_REQUEST['to'];?>"onclick="return confirm('Are you sure?\n\nDo you want to download this?')"><img src="<?php echo MEDIA;?>images/download.png" width="32" height="32" border="0" />&nbsp;&nbsp;Download</a>|
                <a href="<?php echo ADOPTREPORT;?>process.php?action=preview&from=<?php echo $_REQUEST['from'];?>&to=<?php echo $_REQUEST['to'];?>"><img src="<?php echo MEDIA;?>images/view.png" width="32" height="32" border="0" />&nbsp;&nbsp;Preview</a>
      </h2>                                
      </header>
      <?php
