              ...
              <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
               ...
               <tbody>
                <?php
                 ...
                 $qry = mysqli_query($con,"SELECT * from ".TABLE_PREFIX."children_master where center_id='".$_SESSION[SESSION_PREFIX.'login-center-id']."' and children_is_deleted=0");
                

                while($qry_children = mysqli_fetch_array($qry))
                {
...
{
  $qry_app=mysqli_query($con,"select * from ".TABLE_PREFIX."children_master where  center_id='".$_SESSION[SESSION_PREFIX.'login-center-id']."' and children_id='".$_REQUEST['childrenid']."'");
