              ...
              <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
               ...
               <tbody>
                <?php
                 ...
                 $qry= mysqli_query($con,"select * from ".TABLE_PREFIX."donation_master where payment_is_delete=0 and payment_status=1 and center_id='".$_SESSION[SESSION_PREFIX.'login-center-id']."'");
