...
define("HTTP_BASE_URL","http://localhost/projects/orphanage/center/");
...
define("CHILDRENREPORT",MODULES."childrenreport/");
define("DONATIONREQUEST",MODULES."donationrequest/");
define("ADOPTREQUEST",MODULES."adoptrequest/");
define("DONATEREQUEST",MODULES."donaterequest/");


$cid=$_SESSION[SESSION_PREFIX.'login-center-id'];
/////////////app image path/////////
