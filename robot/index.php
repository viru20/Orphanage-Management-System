...
if(empty($_SESSION[SESSION_PREFIX.'login-admin-name']))
{
...
<head>
        ...
        <meta charset="utf-8" />
        <title>Orphanage - Aadmin Panel</title>
    ...
    <?php include("themes/topbar.php"); ?>
        ...
        switch($module)
        {
            ...
            case 7:
            include("modules/report/report.php");
            break;
            ...
            case 16:
            include("modules/newslatter/newslatter.php");
            break;
