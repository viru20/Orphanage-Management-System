  ...
  <section class="wrapper" style='margin-top:70px;display:inline-block;width:100%;'>
    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
      <div class="page-title">
        <div class="pull-left" >
          <h1 class="title">Center News Latter</h1>
        </div>                           
...
<?php if($_REQUEST["action"]=="")
{
  ...
  ?>    
    <form method="post" action="<?php echo NEWSLATTER;?>process.php" name="portal-form" enctype="multipart/form-data">
 ...
 <div class="content-body">
          <div class="row">
             ...
             <div class="form-group">
                <label class="form-label" for="field-1"><b>Subject</b></label>
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="subject" id="subject"  rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
             </div>      
            </div>
             ...
             <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <textarea type="text" class="form-control" name="msg" id="msg" rows="6"></textarea>
               </div>
             </div>      
            </div>
              ...
              <div class="form-group"> 
                 ...
                 <input type="submit" name="submit" value="Send" class="btn btn-blue  pull-center">
              </div>  
