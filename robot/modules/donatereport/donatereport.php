          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <form method="post" action="">
              <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
               ...
               <tbody>
                <?php
              $qry= mysqli_query($con,"select * from ".TABLE_PREFIX."donate_master where donate_is_deleted=0 and donate_status=1 and date='".date('Y-m-d')."'
              ");
          if(isset($_REQUEST['genrate']))
            ...
            if($_REQUEST['from']!=="" && $_REQUEST['to']!=="" && $_REQUEST['centerid']!=="")
            ...
            else 
               {
                ...
                <a href="<?php echo DONATEREPORT;?>process.php?action=download&from=<?php echo $_REQUEST['from'];?>&to=<?php echo $_REQUEST['to'];?>&centerid=<?php echo $_REQUEST['centerid'];?>"onclick="return confirm('Are you sure?\n\nDo you want to download this?')"><img src="<?php echo MEDIA;?>images/download.png" width="30" height="30" border="0" />&nbsp;&nbsp;Download</a>|
                <a href="<?php echo DONATEREPORT;?>process.php?action=preview&from=<?php echo $_REQUEST['from'];?>&to=<?php echo $_REQUEST['to'];?>&centerid=<?php echo $_REQUEST['centerid'];?>"><img src="<?php echo MEDIA;?>images/view.png" width="30" height="30" border="0" />&nbsp;&nbsp;Preview</a>
      </h2>                                
      </header>
      <?php
           }
