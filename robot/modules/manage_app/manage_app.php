          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="controls">
                    <select class="form-control" name="display_ad" id="display_ad">
                      ...
                      <option value="4">AppLovin</option>
           ...
           <div class="clearfix"></div>
            ...
            <div class="form-group">
              ...
              <input type="radio" name="is_ad_show" id="active" class="" value="1" checked="checked">
              <label class="iradio-label form-label" for="minimal-radio-4">Yes</label>&nbsp;
              <input type="radio" name="is_ad_show" id="inactive" class="" value="0">
          ...
          <div class="row">
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="g_banner" id="g_banner" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="g_native" id="g_native" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
                </div>
              </div>      
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="g_interstitial" id="g_interstitial" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
                </div>
              </div>      
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="g_video" id="g_video" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
                </div>
              </div>      
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="fb_banner" id="fb_banner" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="fb_native" id="fb_native" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
                </div>
              </div>      
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="fb_interstitial" id="fb_interstitial" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
                </div>
              </div>      
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="fb_video" id="fb_video" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
                </div>
              </div>      
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="game_id" id="game_id" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="appLovin_id" id="appLovin_id" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="s_app_id" id="s_app_id" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="s_dev_id" id="s_dev_id" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="version" id="version" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" class="form-control" name="is_update" id="is_update" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" class="form-control" name="spin_time" id="spin_time" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="total_spin" id="total_spin" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="total_search_card" id="total_search_card" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="crash_card_random_amount" id="crash_card_random_amount" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="MinWidhrawAmount" id="MinWidhrawAmount" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-8"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="MinWidhrawwatnmsg" id="MinWidhrawwatnmsg" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="rateus" id="rateus" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="ratebonus" id="ratebonus" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="ratebonusamt" id="ratebonusamt" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="dailybonusamt" id="dailybonusamt" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-8"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="dailybonusdailogmsg" id="dailybonusdailogmsg" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="dimondrs" id="dimondrs" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="dimonddoller" id="dimonddoller" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="dimondero" id="dimondero" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="videobtn" id="videobtn" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="videocount" id="videocount" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="spinonvideo" id="spinonvideo" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" class="form-control" name="full_next_count" id="full_next_count" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-4"> 
              <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" class="form-control" name="privacy_policy" id="privacy_policy" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
              </div>          
            </div>
            ...
            <div class="col-md-8"> 
              <div class="form-group">
                ...
                <div class="controls col-md-4">
                    <input type="text" class="form-control" name="jackpotrangfrom" id="jackpotrangfrom" rows="3" style="border: 2px solid #ccc;border-radius: 10px;" placeholder="From">
                </div>
                    
                <div class="controls col-md-4">
                    <input type="text" class="form-control" name="jackpotrangto" id="jackpotrangto" rows="3" style="border: 2px solid #ccc;border-radius: 10px;" placeholder="To">
                </div>
               </div>
              </div> 
              <div class="clearfix"></div>
              ...
              <div class="form-group">
                ...
                <input type="radio" name="is_full" id="active" class="" value="1" >
                <label class="iradio-label form-label" for="minimal-radio-4">Yes</label>&nbsp;
                <input type="radio" name="is_full" id="inactive" class="" value="0" checked="checked">
                <label class="iradio-label form-label" for="minimal-radio-4">No</label>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="radio" name="is_native" id="active" class="" value="1" >
                <label class="iradio-label form-label" for="minimal-radio-4">Yes</label>&nbsp;
                <input type="radio" name="is_native" id="inactive" class="" value="0" checked="checked">
                <label class="iradio-label form-label" for="minimal-radio-4">No</label>
              </div>
              <div class="clearfix"></div>
              ...
              <div class="form-group">
                ...
                <input type="radio" name="is_banner" id="active" class="" value="1" >
                <label class="iradio-label form-label" for="minimal-radio-4">Yes</label>&nbsp;
                <input type="radio" name="is_banner" id="inactive" class="" value="0" checked="checked">
                <label class="iradio-label form-label" for="minimal-radio-4">No</label>
              </div>
              <div class="clearfix"></div>
...
{
  $qry_app=mysqli_query($con,"select * from ".TABLE_PREFIX."package_msater where package_id='".$_REQUEST['manage_appid']."'");
