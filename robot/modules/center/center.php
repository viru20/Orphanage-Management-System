      ...
      <div class="page-title">
        ...
        <div class="pull-right col-lg-8">                                  
          ...
          $active=0; 
            ...
            $active=active_count(TABLE_PREFIX."center_master","center_status","center_is_deleted");
          ?>
          ...
          <?php 
            $inactive=inactive_count(TABLE_PREFIX."center_master","center_status","center_is_deleted");
          ...
          <?php 
            ...
            $deleted=deleted_count(TABLE_PREFIX."center_master","center_is_deleted");
          ?>
          <div class="col-lg-3 col-md-4 col-xs-6 col-sm-4">
     ...
     <section class="box ">
      <header class="panel_header">
        <h2 class="title pull-right">
            ...
            <a href="<?php echo HTTP_BASE_URL;?>center-add"><img src="<?php echo MEDIA;?>images/add.png" width="16" height="16" border="0" />&nbsp;&nbsp;Add Record</a>
              ...
              <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
               ...
               <tbody>
                <?php
                 ...
                 $qry= mysqli_query($con,"select * from ".TABLE_PREFIX."center_master where center_is_deleted=0");
                
                while($result_center= mysqli_fetch_array($qry))
                {
                    ?>
                    
                      <td><?php echo $result_center["center_id"];?></td>
                      <td><img src="<?php echo CENTER_IMAGE.$result_center['center_head_image'];?>" height="100" width="100"></td>
                      <td><?php echo $result_center["center_name"];?></td>
                      <td><?php echo $result_center["center_head_name"];?></td>
                      <td><?php
                      $date= strtotime($result_center["center_reg_date"]);
                      $date = date('d-M-Y',$date); 
                      echo $date;
                      ?></td>
                     
                      <td align="center"><a href="<?php echo CENTER;?>process.php?action=center_status&id=<?php echo $result_center['center_id'];?>&value=<?php echo $result_center["center_status"];?>" onclick="return confirm('Are you sure to change current status?')"><img src="<?php echo MEDIA;?>images/<?php echo display_status_icon($result_center["center_status"]);?>" width="14" height="14" border="0" /></a></td>
                      <td align="center"><a href="<?php echo HTTP_BASE_URL;?>center-edit-<?php echo $result_center['center_id']?>"><img src="<?php echo MEDIA;?>images/edit.png" width="14" height="14" border="0" /></a></td>
                      <td align="center"><a href="<?php echo CENTER;?>process.php?action=delete&id=<?php echo $result_center['center_id']?>" title="Delete" onclick="return confirm('Are you sure?\n\nDo you want to remove this?')"><img src="<?php echo MEDIA;?>images/delete.png" width="14" height="14" border="0" /></a></td>
      ...
      <section class="box ">
        <header class="panel_header">                           
          <ol class="breadcrumb">
            ...
            <li>
              <a href="<?php echo HTTP_BASE_URL;?>center">center</a>
            </li>
            <li class="active">
        ...
        <div class="content-body">
          <div class="row">
            <div class="col-md-6">
             <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" class="form-control" name="cname" id="cname" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
             </div>      
            </div>
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="date" class="form-control" name="rdate" id="rdate" rows="10" style="border: 2px solid #ccc;border-radius: 10px;">
                </div>
              </div>
            </div>  
          ...
          <div class="row">
            <div class="col-md-6">
             <div class="form-group">
                <label class="form-label" for="field-1"><b>Head_Name</b></label>
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <input type="text" class="form-control" name="pname" id="pname" rows="3" style="border: 2px solid #ccc;border-radius: 10px;">
               </div>
             </div>      
            </div>
            ...
            <div class="col-md-6">  
              <div class="form-group">
                <label class="form-label" for="field-1"><b>Head_Img</b></label>
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
...
?>
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                ...
                <!-- <span class="desc">e.g. "Men, Women, Kids etc."</span> -->
                <div class="controls">
                    <textarea class="form-control" name="history" id="history" rows="6" style="border: 2px solid #ccc;border-radius: 10px;"></textarea>
                </div>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="controls">
                    <input type="password" class="form-control" name="password" id="password" rows="10" style="border: 2px solid #ccc;border-radius: 10px;">
                        ...
                        <div class="clearfix"></div>
              <div class="form-group"> 
                 <input type="hidden" name="action" id="action" value="newcenter">
...
{
  $qry_app=mysqli_query($con,"select * from ".TABLE_PREFIX."center_master where center_id='".$_REQUEST['centerid']."'");
      ...
      <section class="box ">
        <header class="panel_header">                           
          <ol class="breadcrumb">
            ...
            <li>
              <a href="<?php echo HTTP_BASE_URL;?>center">Center Details</a>
            </li>
            <li class="active">
...
?>
            ...
            <div class="col-md-6"> 
              ...
              <div class="form-group"> 
                 ...
                 <input type="hidden" name="id" id="id" value="<?php echo $_REQUEST['centerid']; ?>">
                 <input type="submit" name="submit" value="Submit" class="btn btn-blue  pull-center">
                 <a href="<?php echo HTTP_BASE_URL;?>center"><button type="button" class="btn btn-blue  pull-center">Back</button></a>
              </div>  
